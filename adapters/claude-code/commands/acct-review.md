---
description: Dispatch an independent accounting review of the deliverable — never a self-review.
---

Dispatch the **acct-reviewer** subagent (via Task) to review the accounting deliverable against the approved plan. It runs in a fresh context and did not produce this work — do not review your own output and do not summarise it for the reviewer; it reads the artifacts itself.
...
```bash
hatstack review accounting --files "<glob of the deliverable>"
```
