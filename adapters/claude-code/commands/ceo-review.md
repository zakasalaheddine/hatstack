---
description: Dispatch an independent business strategy review of the deliverable — never a self-review.
---

Dispatch the **ceo-reviewer** subagent (via Task) to review the business strategy deliverable against the approved plan. It runs in a fresh context and did not produce this work — do not review your own output and do not summarise it for the reviewer; it reads the artifacts itself.
...
```bash
hatstack review ceo --files "<glob of the deliverable>"
```
